...
Page({
  ...
  getOurHireInfo: function () {
    var that = this;
    var url = `${app.apiUrl}instrument/secondHandler/upload`;
  ...
  hireProductInfo: function (e) {
    ...
    wx.navigateTo({
      url: '../publish-info/publish-info?id=' + id,
    })
  },
  ...
  switchChange: function (e) {
    ...
    var url = `${app.apiUrl}instrument/secondHandler/status?id=${id}&status=${status}`;
  ...
  goToHire: function () {
    wx.navigateTo({
      url: '/pages/second-publish/second-publish'
    })
  }
})